      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-4 flex items-center gap-6">
          ...
          <Link to="/" className="flex items-center group" data-testid="logo-link">
            <img src="/rang-mohor-logo-v3.png" alt="Rang Mohor" className="h-14 md:h-16 w-auto object-contain transition-transform duration-500 group-hover:scale-105 block dark:hidden" />
            <img src="/rang-mohor-logo-white-v3.png" alt="Rang Mohor" className="h-14 md:h-16 w-auto object-contain transition-transform duration-500 group-hover:scale-105 hidden dark:block" />
          </Link>
